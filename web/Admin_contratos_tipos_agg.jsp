...
<html>
    <head>
        ...
        <title>Agregar tipo de contratos</title>
        ...
        <section class="u-clearfix u-section-1" id="sec-4739">
            <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
                <div class="u-form u-form-1">
                    <form action="Servlet_Contratos_tiposAgg" method="POST"   name="form" style="padding: 10px;">
                        <div class="u-form-group u-form-partition-factor-2 u-form-group-5">
                            <label for="text-dca0" class="u-label">Descripcion de contrato</label>
                            <input type="text" id="descripcion" placeholder="Introduzca una descripcion del tipo de contrato" name="descripcion" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
                        </div>
                        <div class="u-form-group u-form-partition-factor-2 u-form-group-4">
                            <label for="text-dca0" class="u-label">Valor total</label>
                            <input type="number" step="any"  id="valor_total"  name="valor_total" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"  maxlength="10" required >
                        </div>
                        <div class="u-form-group u-form-partition-factor-2 u-form-group-3">
                            <label for="text-9e0b" class="u-label">Valor de entrada</label>
                            <input type="number" step="any" id="valor_entrada" name="valor_entrada" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"  required>
                        </div>
                        <div class="u-form-group u-form-partition-factor-2 u-form-group-4">
                            <label for="text-dca0" class="u-label">Saldo</label>
                            <input type="number" step="any" id="saldo"  name="saldo" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
                        </div>
                        <div class="u-form-group u-form-partition-factor-2 u-form-group-5">
                            <label for="text-dca0" class="u-label">Cantidad de meses</label>
                            <input type="number" id="catidad_meses"  name="catidad_meses" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
                        </div>
                        <div class="u-form-group u-form-partition-factor-2 u-form-group-5">
                            <label for="text-dca0" class="u-label">Valor por mes</label>
                            <input type="number" step="any" id="valor_mes"  name="valor_mes" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
                        </div>
