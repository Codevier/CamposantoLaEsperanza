        ...
        <section class="u-clearfix u-section-1" id="sec-4739">
            <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
                <div class="u-form u-form-1">
                    ...
                    <form action="Servlet_ContratoRenoAgg?id_contrato=${id_contrato}" method="POST"  name="form" style="padding: 10px;">
                        ...
                        <div style="width: 50%; float:left" class="u-form-group u-form-partition-factor-2 u-form-group-4">
                            <label for="text-3a01" class="u-label">Nuevo tipo de contrato</label>
                        ...
                        <div style="width: 50%; float:right" class="u-form-group u-form-partition-factor-2 u-form-group-4">
                            <label for="text-3a01" class="u-label">Tipo de contrato anterior</label>
                            <input disabled value="${tipo_contrato}"  type="text" id="text-ae35" name="papeleta" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
                        <div style="width: 100%; float:left" class="u-form-group u-form-partition-factor-2 u-form-group-3">
                            ...
                            <input  type="text" id="text-ae35" name="papeleta" placeholder="Si el valor actual es mayor al contrato original se debe hacer un deposito"  class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
                        <div style="width: 50%; float:left" class="u-form-group u-form-partition-factor-4 u-form-group-8">
                            <label for="text-f7c8" class="u-label">Valor de propiedad (cambio)</label>
                        ...
                        <div style="width: 50%; float:right" class="u-form-group u-form-partition-factor-4 u-form-group-8">
                            <label for="text-f7c8" class="u-label">Entrada (cambio)</label>
                        ...
                        <div style="width: 50%; float:left" class="u-form-group u-form-partition-factor-4 u-form-group-9">
                            <label for="text-7fc3" class="u-label">Cantidad de meses (cambio):</label>
                        ...
                        <div style="width: 50%; float:left" class="u-form-group u-form-partition-factor-4 u-form-group-11">
                            <label for="text-49fa" class="u-label">Valor por mes (cambio):</label>
                            <input id="valor_por_mes" disabled  name="valor_por_mes" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
                        <div style="width: 50%; float:left" class="u-form-group u-form-partition-factor-4 u-form-group-8">
                            <label for="text-f7c8" class="u-label">Valor de la propiedad (anterior)</label>
                            <input disabled value="${valor}"  id="valor_propiedad2" name="valor_propiedad2" disabled  class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
                        <div style="width: 50%; float:right" class="u-form-group u-form-partition-factor-4 u-form-group-8">
                            <label for="text-f7c8" class="u-label">Entrada (anterior)</label>
                            <input value="${entrada}" id="entrada2" name="entrada2" disabled  class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
                        <div style="width: 50%; float:left" class="u-form-group u-form-partition-factor-4 u-form-group-9">
                            <label for="text-7fc3" class="u-label">Cantidad de meses (anterior):</label>
                            <input value="${cant_meses}" id="cantidad_meses2" disabled  name="cantidad_meses2" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
                        <div style="width: 50%; float:left" class="u-form-group u-form-partition-factor-4 u-form-group-11">
                            <label for="text-49fa" class="u-label">Valor por mes (anterior):</label>
                            <input value="${val_mes}" id="valor_por_mes2" disabled  name="valor_por_mes2" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
                        <div class="u-form-group u-form-partition-factor-4 u-form-group-8">
                            <label for="text-f7c8" class="u-label">Id de propiedad:</label>
                            <input id="tipo_propiedad" name="tipo_propiedad" disabled value="${propiedad}" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
                        <div style="width: 50%; float:left" class="u-form-group u-form-partition-factor-2 u-form-group-3">
                            ...
                            <input type="text" disabled value="${difunto_nombre}" id="text-ae35" name="nombres_difunto"  class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
                        <div style="width: 50%; float:left" class="u-form-group u-form-partition-factor-2 u-form-group-3">
                            <label for="text-ae35" class="u-label">Apellidos del Difunto:</label>
                            <input type="text" disabled value="${difunto_apellido}" id="text-ae35" name="apellidos_difunto" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
                        <div  class="u-form-group u-form-partition-factor-2 u-form-group-3">
                            <label for="text-ae35" class="u-label">Cedula del Difunto:</label>
                            <input disabled value="${difunto_cedula}" type="text" id="text-ae35" name="cedula_difunto"   class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
                        <div  class="u-form-group u-form-partition-factor-2 u-form-group-3">
                            <label for="text-ae35" class="u-label">Fecha de defuncion</label>
                            <input disabled value="${difunto_fecha}" id="text-ae35" name="fecha_defuncion"  class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
                        
                        <div class="u-form-group u-form-group-2">
                            <label for="text-c714" class="u-label">Direccion donde vivia del Difunto:</label>
                            <input disabled value="${difunto_dir}" type="text" placeholder="Direccion" id="text-c714"   name="direccion_difunto"  class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                        </div>
