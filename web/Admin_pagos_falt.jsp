                                    ...
                                    <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
                                        <div class="u-expanded-width u-table u-table-responsive u-table-1">
                                            <form action = "SearchName" method = "post"> <! - El nombre del servlet es SearchName ->
                                                Buscar por : 
                                                <select name="OS">
                                                    <option value="1">Id Cuota</option> 
                                                    <option value="2">Fecha de registro</option> 
                                                    <option value="3">Numero de contrato</option>
                                                    <option value="10">Fecha programada</option> 
                                                    <option value="11">Fecha realizado</option> 
                                                    <option value="12">Fecha de registro</option> 
                                                    <option value="14">Valor cancelado</option> 
                                            ...
                                            <table class="u-table-entity u-table-entity-1">
                                                ...
                                                <thead class="u-gradient u-table-header u-table-header-1">
                                                    <tr style="height: 65px;">
                                                        <th class="u-table-cell">Id Cuota</th>
                                                        <th class="u-table-cell">Fecha de registro</th>
                                                        <th class="u-table-cell">Numero de contrato</th>
                                                        <th class="u-table-cell">Fecha programada</th>
                                                        <th class="u-table-cell">Fecha realizado</th>
                                                        <th class="u-table-cell">Fecha de registro</th>
                                                        <th class="u-table-cell">Valor cancelado</th>
                                                ...
                                                <tbody class="u-table-alt-palette-3-light-3 u-table-body u-table-body-1">
                                                    <tr style="height: 65px;">
                                                        ...
                                                        <td class="u-table-cell">0302</td>
                                                        <td class="u-table-cell">15-08-2021</td>
                                                        <td class="u-table-cell">15-08-2021</td>
                                                        <td class="u-table-cell">15-08-2021</td>
                                                        <td class="u-table-cell">29.44</td>
