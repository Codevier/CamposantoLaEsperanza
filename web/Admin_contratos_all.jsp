                            ...
                            <table id="datos" class="u-table-entity u-table-entity-1" >                                                        
                                <thead class="u-gradient u-table-header u-table-header-1">                                                          
                                    <tr>                                                                
                                        ...
                                        <td onclick="sortTable(1, 'str')"><strong>numero</strong></td> 
                                        <td onclick="sortTable(2, 'str')"><strong>propiedad</strong></td>
                                        <td onclick="sortTable(3, 'str')"><strong>estado</strong></td>
                                        <td onclick="sortTable(4, 'str')"><strong>papeleta</strong></td>
                                        <td onclick="sortTable(5, 'str')"><strong>cliente</strong></td>
                                        <td onclick="sortTable(6, 'str')"><strong>usuario</strong></td>
                                        <td onclick="sortTable(7, 'str')"><strong>registro</strong></td>
                                        <td onclick="sortTable(8, 'str')"><strong>descripcion</strong></td>
                                        <td onclick="sortTable(9, 'str')"><strong>valor total</strong></td>
                                        <td onclick="sortTable(10, 'str')"><strong>valor entrada</strong></td>
                                        <td onclick="sortTable(11, 'str')"><strong>meses</strong></td>
                                        <td onclick="sortTable(12, 'str')"><strong>valor/mes</strong></td>
                                        <td onclick="sortTable(13, 'str')"><strong>cedula difunto</strong></td>
                                        ...
                                        <td colspan=4><center><strong>ACCIONES</strong></center></td>                                                        
                                    </tr>                                                        
                                </thead>                                                        
                                <tbody class="u-table-alt-palette-3-light-3 u-table-body u-table-body-1">                                                            
                                    <c:forEach var="Objeto" items="${lista}">                                                                                                                                
                                        <tr>                                                                                      
                                            ...
                                            <c:choose>
                                                <c:when test="${Objeto.estado=='renovado'}">
                                                    <td><a href="Servlet_Reestructuracion_Contrato?numero_contrato=${Objeto.numero_contrato}">Imprimir contrato renovado</a></td>   
                                                </c:when>
                                                <c:otherwise>
                                                    
                                             <td><a href="Servlet_GenerarContrato?numero_contrato=${Objeto.numero_contrato}">Imprimir contrato</a></td>  
                                                </c:otherwise>
                                               
                                            </c:choose>
                                            
                                            <td><a href="Servlet_ContratosCuotas?id_contrato=${Objeto.id_contrato}">Ver cuotas</a></td>
                                            <td><a href="Servlet_Certificado_Inhumacion?numero_contrato=${Objeto.numero_contrato}">Certificado Inhumacion</a></td>
                                             <td><a href="Servlet_Cesion_Derechos?numero_contrato=${Objeto.numero_contrato}">Cesión de derechos</a></td>
