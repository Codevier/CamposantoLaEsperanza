        ...
        <section class="u-clearfix u-section-1" id="sec-4739">
            <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
                <div class="u-form u-form-1">
                    <form action="Servlet_UsuarioAgg?cedula=<%= request.getParameter("cedula")%>" method="POST"   name="form" style="padding: 10px;">
                        <div style="width: 50%; float:left" class="u-form-group u-form-partition-factor-2 u-form-group-3">
                            ...
                            <input disabled value="<%= request.getParameter("cedula")%>" type="text" id="text-9e0b" placeholder="Introduzca su número de identificación" name="cedulaUsuario" id="cedulaUsuario" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required>
                        ...
                        <div style="width: 50%; float:right" class="u-form-group u-form-partition-factor-2 u-form-group-4">
                            ...
                            <input type="text" id="text-dca0" placeholder="Introduzca su número identificación" name="nombreUsuario" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white"  maxlength="10" required >
                        </div>
                        <div style="width: 50%; float:left" class="u-form-group u-form-partition-factor-2 u-form-group-3">
                        ...
                        <div style="width: 50%; float:right" class="u-form-group u-form-partition-factor-2 u-form-phone u-form-group-5">
                            ...
                            <input required type="tel" pattern="[0-9]{10}" maxlength="10" minlength="10" placeholder="Introduzca su número convencional" id="text-a113" name="numerocelular" id="numerocelular" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" onkeypress='return validaNumericos(event)'>
                        </div>
                        ...
                        <div class="u-form-group u-form-partition-factor-2 u-form-group-3">
                            ...
                            <input required type="password" id="text-9e0b" placeholder="Introduzca su contraseña" name="contrasenia" id="contrasenia" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" >
                        </div>
                        <div class="u-form-group u-form-partition-factor-2 u-form-group-4">
