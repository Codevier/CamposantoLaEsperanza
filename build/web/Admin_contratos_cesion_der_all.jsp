                            ...
                            <table id="datos" class="u-table-entity u-table-entity-1" >                                                        
                                <thead class="u-gradient u-table-header u-table-header-1">                                                          
                                    <tr>                                                                
                                        ...
                                        <td onclick="sortTable(3, 'str')"><strong>cedula cliente</strong></td>
                                        <td onclick="sortTable(4, 'str')"><strong>nombres cliente</strong></td>
                                        <td onclick="sortTable(5, 'str')"><strong>usuario</strong></td>
                                        <td onclick="sortTable(6, 'str')"><strong>registro</strong></td>
                                        <td onclick="sortTable(7, 'str')"><strong>descripcion</strong></td>
                                        <td onclick="sortTable(8, 'str')"><strong>valor total</strong></td>
                                        <td onclick="sortTable(9, 'str')"><strong>valor entrada</strong></td>
                                        <td onclick="sortTable(10, 'str')"><strong>meses</strong></td>
                                        <td onclick="sortTable(11, 'str')"><strong>valor/mes</strong></td>
                                        <td onclick="sortTable(12, 'str')"><strong>cedula difunto</strong></td>
                                ...
                                <tbody class="u-table-alt-palette-3-light-3 u-table-body u-table-body-1">                                                            
                                    <c:forEach var="Objeto" items="${lista}">                                                                                                                                
                                        <tr>                                                                                      
                                            ...
                                            <td><a href="Servlet_ContratoCedente?id_contrato=${Objeto.id_contrato}&Ced_client=${Objeto.cedula_cliente}">Transferir derechos</a></td>    
                                        </tr>                                                            
                                    </c:forEach>                                                        
                                </tbody>                 
                            </table>         
