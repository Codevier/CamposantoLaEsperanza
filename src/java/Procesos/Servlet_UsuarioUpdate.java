 ...
 * @author Usuario
 */
public class Servlet_UsuarioUpdate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servlet_UsuarioUpdate</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Servlet_UsuarioUpdate at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String clave_d=encript(u.getClave());
            u.setClave(clave_d);
            exito = cone.Update_Usuarios(u);
            ...
            Logger.getLogger(Servlet_UsuarioUpdate.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
