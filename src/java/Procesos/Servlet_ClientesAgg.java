 ...
 * @author Usuario
 */
public class Servlet_ClientesAgg extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servlet_ClientesAgg</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Servlet_ClientesAgg at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            exito=cone.Insert_Clientes(u);            
            if (exito) {
                out.println("<html><head></head><body onload=\"alert('Se registró correctamente'); window.location='Admin_cliente_agg_c.jsp' \"></body></html>");
            } else {
                out.println("<html><head></head><body onload=\"alert('No se registró el cliente'); window.location='Admin_cliente_agg_c.jsp'\"></body></html>");
            }
