 ...
 * @author Usuario
 */
public class Servlet_InventarioEliminar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                exito = cone.Delete_Inventario(idPropiedad);
                PrintWriter pw = response.getWriter();

                if (exito) {
                    respuesta="Se elimino la propiedad con id "+idPropiedad;
                } else {
                    respuesta="No se puede eliminar, es posible que el usuario este relacionado en otra tabla";
                }
            String[][] Inventario= cone.Inventario();
            List<Propiedad> listaPropiedades = new ArrayList<>();
            listaPropiedades=Propiedad.listarPropiedades(Inventario);
            
            RequestDispatcher dispatcher = request.getRequestDispatcher("/Admin_inventario_all.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(Servlet_InventarioEliminar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
