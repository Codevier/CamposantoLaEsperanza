 ...
 * @author Usuario
 */
public class Servlet_CuotasCobrar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String id = request.getParameter("id");
            ...
            Boolean exito;
            exito=cone.CobrarCuota(id,papeleta,valor);
            if (exito) {
                ...
                out.println("<html><head></head><body onload=\"alert('No se registro'); window.location='Admin_home.jsp'\"></body></html>");
            }
    }
