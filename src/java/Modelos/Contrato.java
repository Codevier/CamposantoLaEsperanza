...
public class Contrato {
    private String id_contrato, numero_contrato,papeleta,propiedad,cedula_cliente, cedula_user, 
            fecha_del_contrato,valor_de_entrada, descrip_tipo, valor_propiedad, 
            entrada,saldo, cantidad_meses, valor_por_mes,   
            nombres_difunto, apellidos_difunto, cedula_difunto, fecha_defuncion, direccion_difunto, estado;

    public Contrato() {
    }

    public Contrato(String id_contrato, String numero_contrato, String papeleta, String propiedad, String cedula_cliente, String cedula_user, String fecha_del_contrato, String valor_de_entrada, String descrip_tipo, String valor_propiedad, String entrada, String saldo, String cantidad_meses, String valor_por_mes, String nombres_difunto, String apellidos_difunto, String cedula_difunto, String fecha_defuncion, String direccion_difunto) {
        ...
        this.direccion_difunto = direccion_difunto;
    }
    ...
    public String getDireccion_difunto() {
        return direccion_difunto;
    }

    public void setDireccion_difunto(String direccion_difunto) {
        this.direccion_difunto = direccion_difunto;
    }
